...
def t_on_subset(dataset, cnn, n, pred_vectors, all_label,
                   consider_trains):
    hit = 0
    tot = 0
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cnn',default='save/resnet-fit/epoch-600.pth')#可能会是save/resnet-fit/epoch-{}.pth
    parser.add_argument('--pred',default='save/gcn-dense-att/epoch-3000.pred')#可能会是save/gcn-dense-att/epoch-{}.pred
    ...
    awa2_path = 'materials/datasets/awa2/AwA2/Animals_with_Attributes2'#可能要修改

    for i, name in enumerate(test_names, 1):
        dataset = ImageFolder(osp.join(awa2_path, 'JPEGImages'), [name], 'test')
        hit, tot = t_on_subset(dataset, cnn, n, pred_vectors, n + i - 1,
